...
/* GAP PID */
#define PATH_GAP_PID "/var/run/gap20.pid"

/* HA PID */
#define PATH_HA_PID "/var/run/ha.pid"

/* UPGRADE PID */
#define PATH_UPGRADE_PID "/var/run/upgrade.pid"
...
#define APP_VTYSH_PATH "/var/run/app.vty"
#define HA_VTYSH_PATH "/var/run/ha.vty"
#define GU_VTYSH_PATH "/var/run/gu.vty"
