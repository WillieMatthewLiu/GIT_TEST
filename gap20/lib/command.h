...
enum node_type
{
	...
	DPI_FW_INDUSTRY_NODE,
	DPI_FW_USER_NODE,
	DPI_FW_FILTER_NODE,
	DPI_FW_WHITELIST_NODE,
	DPI_FW_DEFEND_NODE,
	APP_NODE,
	HA_NODE,
	GAP_OUTER_NODE,
...
#define NO_STR "Undo a configuration\n"
...
#define AREA_TAG_STR "[area tag]\n"
#define DPI_STR  "Indicate DPI configuration\n"
#define INNER_STR "Indicate Inner machine\n"
#define ARBITER_STR "Indicate Abiter machine\n"
#define OUTER_STR "Indicate Outer machine\n"
#define RESET_STR "Reset configuration\n"


#define CONF_BACKUP_EXT ".sav"
#define CONF_PRIV_EXT ".priv"
...
extern void reset_config_cb_register(reset_config_cb cb);


extern void install_ignore_log_cmd(struct cmd_element *cmd);
extern int is_ignore_log_cmd(struct cmd_element *cmd);
