...
extern void zlog_emerg(const char *format, ...)PRINTF_ATTRIBUTE(1, 2);
extern void zlog_critical(const char *format, ...)PRINTF_ATTRIBUTE(1, 2);
extern void zlog_alert(const char *format, ...)PRINTF_ATTRIBUTE(1, 2);
