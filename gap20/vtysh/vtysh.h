...
#define VTYSH_APP   0x400
#define VTYSH_GAP20 VTYSH_APP
#define VTYSH_HA    0x800
#define VTYSH_GU    0x1000
#define VTYSH_UPGRADE VTYSH_GU
#define VTYSH_ALL	  VTYSH_GU|VTYSH_HA|VTYSH_APP|VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_BGPD|VTYSH_ISISD|VTYSH_BABELD
#define VTYSH_RMAP	  VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_BGPD|VTYSH_BABELD
#define VTYSH_INTERFACE	  VTYSH_HA|VTYSH_APP|VTYSH_ZEBRA|VTYSH_RIPD|VTYSH_RIPNGD|VTYSH_OSPFD|VTYSH_OSPF6D|VTYSH_ISISD|VTYSH_BABELD
...
void vtysh_notify_username(void *client, const char * username);
int set_disp_mode(int fd, int option);
int getpasswd(char* passwd, int size);
int vtysh_execute_no_pager_log(const char *line);
