...
#define OUTER_SHOW() \
    do{\
        char *cp = vty->buf;\
        while(isspace(*cp)) cp++;\
        if(RUN_AS_INNER() && strstr(cp, "outer")){\
...
ALIAS(ip_mroute_dist,
       outer_ip_mroute_dist_cmd,
       "outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) <1-255>",
       OUTER_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_mroute_dist,
       outer_ip_mroute_cmd,
       "outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE)",
       OUTER_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_mroute_dist_vrf,
       outer_ip_mroute_dist_vrf_cmd,
       "outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) <1-255> " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_mroute_dist_vrf,
       outer_ip_mroute_vrf_cmd,
       "outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) "VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_mroute_dist,
       no_outer_ip_mroute_dist_cmd,
       "no outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) <1-255>",
       IP_STR
       OUTER_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_mroute_dist,
       no_outer_ip_mroute_cmd,
       "no outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE)",
       NO_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_mroute_dist_vrf,
       no_outer_ip_mroute_dist_vrf_cmd,
       "no outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) <1-255> " VRF_CMD_STR,
       IP_STR
       OUTER_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_mroute_dist_vrf,
       no_outer_ip_mroute_vrf_cmd,
       "no outer ip mroute A.B.C.D/M (A.B.C.D|INTERFACE) " VRF_CMD_STR,
       NO_STR
       OUTER_STR
       IP_STR
       "Configure static unicast route into MRIB for multicast RPF lookup\n"
...
ALIAS(ip_multicast_mode,
       outer_ip_multicast_mode_cmd,
       "outer ip multicast rpf-lookup-mode (urib-only|mrib-only|mrib-then-urib|lower-distance|longer-prefix)",
       OUTER_STR
       IP_STR
       "Multicast options\n"
       "RPF lookup behavior\n"
...
ALIAS(no_ip_multicast_mode,
       no_outer_ip_multicast_mode_cmd,
       "no outer ip multicast rpf-lookup-mode (urib-only|mrib-only|mrib-then-urib|lower-distance|longer-prefix)",
       NO_STR
       OUTER_STR
       IP_STR
       "Multicast options\n"
...
ALIAS(no_ip_multicast_mode,
       no_outer_ip_multicast_mode_noarg_cmd,
       "no outer ip multicast rpf-lookup-mode",
       NO_STR
       OUTER_STR
       IP_STR
       "Multicast options\n"
...
ALIAS(show_ip_rpf,
       show_outer_ip_rpf_vrf_cmd,
       "show outer ip rpf " VRF_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "Display RPF information for multicast source\n"
...
ALIAS(show_ip_rpf_addr,
       show_outer_ip_rpf_addr_cmd,
       "show outer ip rpf A.B.C.D",
       SHOW_STR
       OUTER_STR
       IP_STR
       "Display RPF information for multicast source\n"
...
ALIAS(show_ip_rpf_addr,
       show_outer_ip_rpf_addr_vrf_cmd,
       "show outer ip rpf A.B.C.D " VRF_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "Display RPF information for multicast source\n"
...
ALIAS(show_ip_rpf_vrf_all,
       show_outer_ip_rpf_vrf_all_cmd,
       "show outer ip rpf " VRF_ALL_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "Display RPF information for multicast source\n"
...
ALIAS(show_ip_rpf_addr_vrf_all,
       show_outer_ip_rpf_addr_vrf_all_cmd,
       "show outer ip rpf A.B.C.D " VRF_ALL_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "Display RPF information for multicast source\n"
...
ALIAS(ip_route, 
       outer_ip_route_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0)",
       "outer side\n"
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_tag,
       outer_ip_route_tag_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_tag_vrf,
       outer_ip_route_tag_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535>" VRF_CMD_STR,
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags,
       outer_ip_route_flags_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole)",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags_tag,
       outer_ip_route_flags_tag_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags_tag_vrf,
       outer_ip_route_flags_tag_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>" VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags2,
       outer_ip_route_flags2_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole)",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags2_tag,
       outer_ip_route_flags2_tag_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags2_tag_vrf,
       outer_ip_route_flags2_tag_vrf_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(ip_route_mask,
       outer_ip_route_mask_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0)",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_tag,
       outer_ip_route_mask_tag_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_tag_vrf,
       outer_ip_route_mask_tag_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535>" VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags,
       outer_ip_route_mask_flags_cmd,
       "ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole)",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(ip_route_mask_flags_tag,
       outer_ip_route_mask_flags_tag_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags_tag_vrf,
       outer_ip_route_mask_flags_tag_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>" VRF_CMD_STR,
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags2,
       outer_ip_route_mask_flags2_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole)",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags2_tag,
       outer_ip_route_mask_flags2_tag_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags2_tag_vrf,
       outer_ip_route_mask_flags2_tag_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_distance,
       outer_ip_route_distance_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_tag_distance,
       outer_ip_route_tag_distance_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_tag_distance_vrf,
       outer_ip_route_tag_distance_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags_distance,
       outer_ip_route_flags_distance_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags_tag_distance,
       outer_ip_route_flags_tag_distance_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags_tag_distance_vrf,
       outer_ip_route_flags_tag_distance_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags_distance2,
       outer_ip_route_flags_distance2_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "Emit an ICMP unreachable when matched\n"
...
ALIAS(ip_route_flags_tag_distance2,
       outer_ip_route_flags_tag_distance2_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535> <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "Emit an ICMP unreachable when matched\n"
...
ALIAS(ip_route_flags_tag_distance2_vrf,
       outer_ip_route_flags_tag_distance2_vrf_cmd,
       "outer_ip route A.B.C.D/M (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "Emit an ICMP unreachable when matched\n"
...
ALIAS(ip_route_mask_distance,
       outer_ip_route_mask_distance_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_tag_distance,
       outer_ip_route_mask_tag_distance_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_tag_distance_vrf,
       outer_ip_route_mask_tag_distance_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_tag_distance,
       outer_ip_route_mask_flags_tag_distance_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole)  tag <1-65535> <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_tag_distance_vrf,
       outer_ip_route_mask_flags_tag_distance_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole)  tag <1-65535> <1-255>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_distance,
       outer_ip_route_mask_flags_distance_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_distance2,
       outer_ip_route_mask_flags_distance2_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) <1-255>",
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_tag_distance2,
       outer_ip_route_mask_flags_tag_distance2_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535> <1-255>",
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags_tag_distance2_vrf,
       outer_ip_route_mask_flags_tag_distance2_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(no_ip_route, 
       no_outer_ip_route_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0)",
       NO_STR
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(no_ip_route_tag,
       no_outer_ip_route_tag_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535>",
       NO_STR
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(no_ip_route_tag_vrf,
       no_outer_ip_route_tag_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route,
       no_outer_ip_route_flags_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole)",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_tag,
       no_outer_ip_route_flags_tag_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags2,
       no_outer_ip_route_flags2_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole)",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags2_tag,
       no_outer_ip_route_flags2_tag_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags2_tag_vrf,
       no_outer_ip_route_flags2_tag_vrf_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_mask,
       no_outer_ip_route_mask_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0)",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_tag,
       no_outer_ip_route_mask_tag_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask,
       no_outer_ip_route_mask_flags_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole)",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_tag,
       no_outer_ip_route_mask_flags_tag_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags2,
       no_outer_ip_route_mask_flags2_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole)",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags2_tag,
       no_outer_ip_route_mask_flags2_tag_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags2_tag_vrf,
       no_outer_ip_route_mask_flags2_tag_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_distance,
       no_outer_ip_route_distance_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_tag_distance,
       no_outer_ip_route_tag_distance_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR 
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_tag_distance_vrf,
       no_outer_ip_route_tag_distance_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_distance,
       no_outer_ip_route_flags_distance_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_tag_distance,
       no_outer_ip_route_flags_tag_distance_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_tag_distance_vrf,
       no_outer_ip_route_flags_tag_distance_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_distance2,
       no_outer_ip_route_flags_distance2_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_tag_distance2,
       no_outer_ip_route_flags_tag_distance2_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_flags_tag_distance2_vrf,
       no_outer_ip_route_flags_tag_distance2_vrf_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(no_ip_route_mask_distance,
       no_outer_ip_route_mask_distance_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_tag_distance,
       no_outer_ip_route_mask_tag_distance_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_tag_distance_vrf,
       no_outer_ip_route_mask_tag_distance_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_distance,
       no_outer_ip_route_mask_flags_distance_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_tag_distance,
       no_outer_ip_route_mask_flags_tag_distance_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_tag_distance_vrf,
       no_outer_ip_route_mask_flags_tag_distance_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_distance2,
       no_outer_ip_route_mask_flags_distance2_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) <1-255>",
       NO_STR
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(ip_route_flags_vrf,
       outer_ip_route_flags_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_flags2_vrf,
       outer_ip_route_flags2_vrf_cmd,
       "ip outer route A.B.C.D/M (reject|blackhole) " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_mask_vrf,
       outer_ip_route_mask_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags_vrf,
       outer_ip_route_mask_flags_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_route_mask_flags2_vrf,
       outer_ip_route_mask_flags2_vrf_cmd,
       "ip route A.B.C.D A.B.C.D (reject|blackhole) " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
...
ALIAS(ip_route_distance_vrf,
       outer_ip_route_distance_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) <1-255> " VRF_CMD_STR,
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS (ip_route_flags_distance_vrf,
       outer_ip_route_flags_distance_vrf_cmd,
       "outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) <1-255> " VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
       "IP gateway address\n"
...
ALIAS(ip_route_flags_distance2_vrf,
       outer_ip_route_flags_distance2_vrf_cmd,
       "outer ip route A.B.C.D/M (reject|blackhole) <1-255> " VRF_CMD_STR,
       OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS(ip_route_mask_distance_vrf,
       outer_ip_route_mask_distance_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) <1-255> " VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_distance_vrf,
       outer_ip_route_mask_flags_distance_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) <1-255> " VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS(ip_route_mask_flags_distance2_vrf,
       outer_ip_route_mask_flags_distance2_vrf_cmd,
       "outer ip route A.B.C.D A.B.C.D (reject|blackhole) <1-255> " VRF_CMD_STR,
       OUTER_STR IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
       "IP destination prefix mask\n"
...
ALIAS (no_ip_route_vrf,
       no_outer_ip_route_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_vrf,
       no_outer_ip_route_flags_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_flags2_vrf,
       no_outer_ip_route_flags2_vrf_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_mask_vrf,
       no_outer_ip_route_mask_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_vrf,
       no_outer_ip_route_mask_flags_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags2_vrf,
       no_outer_ip_route_mask_flags2_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS (no_ip_route_distance_vrf,
       no_outer_ip_route_distance_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE|null0) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_flags_distance_vrf,
       no_outer_ip_route_flags_distance_vrf_cmd,
       "no outer ip route A.B.C.D/M (A.B.C.D|INTERFACE) (reject|blackhole) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_flags_distance2_vrf,
       no_outer_ip_route_flags_distance2_vrf_cmd,
       "no outer ip route A.B.C.D/M (reject|blackhole) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix (e.g. 10.0.0.0/8)\n"
...
ALIAS (no_ip_route_mask_distance_vrf,
       no_outer_ip_route_mask_distance_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE|null0) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS (no_ip_route_mask_flags_distance_vrf,
       no_outer_ip_route_mask_flags_distance_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (A.B.C.D|INTERFACE) (reject|blackhole) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS (no_ip_route_mask_flags_distance2_vrf,
       no_outer_ip_route_mask_flags_distance2_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) <1-255> " VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_tag_distance2,
       no_outer_ip_route_mask_flags_tag_distance2_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535> <1-255>",
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(no_ip_route_mask_flags_tag_distance2_vrf,
       no_outer_ip_route_mask_flags_tag_distance2_vrf_cmd,
       "no outer ip route A.B.C.D A.B.C.D (reject|blackhole) tag <1-65535> <1-255>" VRF_CMD_STR,
       NO_STR OUTER_STR
       IP_STR
       "Establish static routes\n"
       "IP destination prefix\n"
...
ALIAS(ip_protocol,
       outer_ip_protocol_cmd,
       "outer ip protocol PROTO route-map ROUTE-MAP",
       OUTER_STR
       NO_STR
       "Apply route map to PROTO\n"
       "Protocol name\n"
...
ALIAS(no_ip_protocol,
       no_outer_ip_protocol_cmd,
       "no outer ip protocol PROTO",
       NO_STR
       OUTER_STR
       "Remove route map from PROTO\n"
       "Protocol name\n")
...
ALIAS (show_ip_route,
       show_outer_ip_route_vrf_cmd,
       "show outer ip route " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       VRF_CMD_HELP_STR)
...
ALIAS(show_ip_route_tag,
       show_outer_ip_route_tag_cmd,
       "show outer ip route tag <1-65535>",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Show only routes with tag\n"
...
ALIAS(show_ip_route_tag,
       show_outer_ip_route_tag_vrf_cmd,
       "show outer ip route tag <1-65535>" VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Show only routes with tag\n"
...
ALIAS (show_ip_route_prefix_longer,
       show_outer_ip_route_prefix_longer_cmd,
       "show outer ip route A.B.C.D/M longer-prefixes",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
...
ALIAS (show_ip_route_prefix_longer,
       show_outer_ip_route_prefix_longer_vrf_cmd,
       "show outer ip route A.B.C.D/M longer-prefixes " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
...
ALIAS (show_ip_route_supernets,
       show_outer_ip_route_supernets_cmd,
       "show outer ip route supernets-only",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Show supernet entries only\n")
...
ALIAS (show_ip_route_supernets,
       show_outer_ip_route_supernets_vrf_cmd,
       "show outer ip route supernets-only " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Show supernet entries only\n"
...
ALIAS (show_ip_route_protocol,
       show_outer_ip_route_protocol_cmd,
       "show outer ip route " QUAGGA_IP_REDIST_STR_ZEBRA,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       QUAGGA_IP_REDIST_HELP_STR_ZEBRA)
...
ALIAS (show_ip_route_protocol,
       show_outer_ip_route_protocol_vrf_cmd,
       "show outer ip route " QUAGGA_IP_REDIST_STR_ZEBRA " " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       QUAGGA_IP_REDIST_HELP_STR_ZEBRA
...
ALIAS (show_ip_route_addr,
       show_outer_ip_route_addr_cmd,
       "show outer ip route A.B.C.D",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Network in the IP routing table to display\n")
...
ALIAS (show_ip_route_addr,
       show_outer_ip_route_addr_vrf_cmd,
       "show outer ip route A.B.C.D " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Network in the IP routing table to display\n"
...
ALIAS (show_ip_route_prefix,
       show_outer_ip_route_prefix_cmd,
       "show outer ip route A.B.C.D/M",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n")
...
ALIAS (show_ip_route_prefix,
       show_outer_ip_route_prefix_vrf_cmd,
       "show outer ip route A.B.C.D/M " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
...
ALIAS (show_ip_route_summary,
       show_outer_ip_route_summary_cmd,
       "show outer ip route summary",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n")
...
ALIAS (show_ip_route_summary,
       show_outer_ip_route_summary_vrf_cmd,
       "show outer ip route summary " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n"
...
ALIAS (show_ip_route_summary_prefix,
       show_outer_ip_route_summary_prefix_cmd,
       "show outer ip route summary prefix",
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n"
...
ALIAS (show_ip_route_summary_prefix,
       show_outer_ip_route_summary_prefix_vrf_cmd,
       "show outer ip route summary prefix " VRF_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n"
...
ALIAS (show_ip_route_vrf_all,
       show_outer_ip_route_vrf_all_cmd,
       "show outer ip route " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       VRF_ALL_CMD_HELP_STR)
...
ALIAS (show_ip_route_prefix_longer_vrf_all,
       show_outer_ip_route_prefix_longer_vrf_all_cmd,
       "show outer ip route A.B.C.D/M longer-prefixes " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
...
ALIAS (show_ip_route_supernets_vrf_all,
       show_outer_ip_route_supernets_vrf_all_cmd,
       "show outer ip route supernets-only " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Show supernet entries only\n"
...
ALIAS (show_ip_route_protocol_vrf_all,
       show_outer_ip_route_protocol_vrf_all_cmd,
       "show outer ip route " QUAGGA_IP_REDIST_STR_ZEBRA " " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       QUAGGA_IP_REDIST_HELP_STR_ZEBRA
...
ALIAS (show_ip_route_addr_vrf_all,
       show_outer_ip_route_addr_vrf_all_cmd,
       "show outer ip route A.B.C.D " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Network in the IP routing table to display\n"
...
ALIAS (show_ip_route_prefix_vrf_all,
       show_outer_ip_route_prefix_vrf_all_cmd,
       "show outer ip route A.B.C.D/M " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n"
...
ALIAS (show_ip_route_summary_vrf_all,
       show_outer_ip_route_summary_vrf_all_cmd,
       "show outer ip route summary " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n"
...
ALIAS (show_ip_route_summary_prefix_vrf_all,
       show_outer_ip_route_summary_prefix_vrf_all_cmd,
       "show outer ip route summary prefix " VRF_ALL_CMD_STR,
       SHOW_STR OUTER_STR
       IP_STR
       "IP routing table\n"
       "Summary of all routes\n"
...
ALIAS(show_ip_protocol,
       show_outer_ip_protocol_cmd,
       "show outer ip protocol",
        SHOW_STR
        OUTER_STR
        IP_STR
       "IP protocol filtering status\n")
...
ALIAS(show_ipv6_mroute,
       show_outer_ipv6_mroute_vrf_cmd,
       "show outer ipv6 mroute " VRF_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "IPv6 Multicast routing table\n"
...
ALIAS(show_ipv6_route_prefix_longer_vrf_all,
       show_outer_ipv6_route_prefix_longer_vrf_all_cmd,
       "show outer ipv6 route X:X::X:X/M longer-prefixes " VRF_ALL_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "IPv6 routing table\n"
...
ALIAS(show_ipv6_mroute_vrf_all,
       show_outer_ipv6_mroute_vrf_all_cmd,
       "show outer ipv6 mroute " VRF_ALL_CMD_STR,
       SHOW_STR
       OUTER_STR
       IP_STR
       "IPv6 Multicast routing table\n"
...
ALIAS(show_ipv6_route_summary_prefix_vrf_all,
       show_outer_ipv6_route_summary_prefix_vrf_all_cmd,
       "show outer ipv6 route summary prefix " VRF_ALL_CMD_STR,
       SHOW_STR
       IP_STR
       "IPv6 routing table\n"
       "Summary of all IPv6 routes\n"
       "Prefix routes\n"
       VRF_ALL_CMD_HELP_STR)
static struct list *dns_list = NULL;
static void write_dns_to_sys(struct list *dns_list)
{
    struct listnode *node;
    struct prefix *dns;
    FILE *f = fopen("/etc/resolv.conf", "w");
    
    for(ALL_LIST_ELEMENTS_RO(dns_list,node, dns))
    {
        fprintf(f, "nameserver %s\n", inet_ntoa(dns->u.prefix4));
    }
    fflush(f);
    fclose(f);
}
    ...
    "Server Ip\n")
{
    ...
    if((board_type == BOARDTYPE_IN)&&(strncmp(self->string, "outer", 5) == 0))
    {
        return vty_adapter_run(vty, vty->usr_data);
    }
    ...
    for(ALL_LIST_ELEMENTS_RO(dns_list, node, dns))
    {
        if(prefix_same(dns, &p))
        {
            return CMD_SUCCESS;
        }
    }

    dns = XMALLOC(MTYPE_PREFIX, sizeof(struct prefix));
    *dns=p;
    listnode_add(dns_list, dns);

    /* write dns to etc resolv.conf */
    write_dns_to_sys(dns_list);
    return CMD_SUCCESS;
}
    ...
    "IP\n")
{
    ...
    if(board_type == BOARDTYPE_IN&&strstr(self->string, "outer"))
    {
        vty_adapter_run(vty, vty->usr_data);
    }
    ...
    for(ALL_LIST_ELEMENTS(dns_list, node, next, dns))
    {
        if(prefix_same(dns, &p))
        {
            listnode_delete(dns_list, dns);
            XFREE(MTYPE_PREFIX, dns);
            break;
        }
    }
...
ALIAS(no_zebra_dns,
    no_outer_zebra_dns_cmd,
    "no outer dns A.B.C.D",
    NO_STR
    "DNS\n"
    "IP\n");

DEFUN(zebra_show_dns,
    zebra_show_dns_cmd,
    "show dns",
    SHOW_STR
    "DNS\n")
{
    ...
    for(ALL_LIST_ELEMENTS_RO(dns_list, node, p))
    {
        vty_out(vty, "  %s%s", inet_ntoa(p->u.prefix4), VTY_NEWLINE);
    }

    return CMD_SUCCESS;
}

ALIAS(zebra_show_dns,
    zebra_show_outer_dns_cmd,
    "show outer dns",
    SHOW_STR
    "DNS\n");

static int static_config_dns(struct vty *vty)
{
    int  write = 0;
    struct prefix * dns;
    struct listnode *node;
    ...
    for(ALL_LIST_ELEMENTS_RO(dns_list, node, dns))
    {
        vty_out(vty, "dns %s%s", inet_ntoa(dns->u.prefix4), VTY_NEWLINE);
        write++;
    }
...
/* for outer */
    zebra_vty_init_outer();
/* for dns */
  install_element (VIEW_NODE, &zebra_show_dns_cmd);
  install_element (VIEW_NODE, &zebra_show_outer_dns_cmd);
  install_element (ENABLE_NODE, &zebra_show_dns_cmd);
  install_element (ENABLE_NODE, &zebra_show_outer_dns_cmd);
  install_element (CONFIG_NODE, &zebra_dns_cmd);
  install_element (CONFIG_NODE, &zebra_outer_dns_cmd);
  install_element (CONFIG_NODE, &no_zebra_dns_cmd);
  install_element (CONFIG_NODE, &no_outer_zebra_dns_cmd);
}

void zebra_vty_init_outer(){
  install_element (CONFIG_NODE, &outer_ip_mroute_cmd);
  install_element (CONFIG_NODE, &outer_ip_mroute_dist_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_mroute_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_mroute_dist_cmd);
  install_element (CONFIG_NODE, &outer_ip_multicast_mode_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_multicast_mode_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_multicast_mode_noarg_cmd);
  install_element (CONFIG_NODE, &outer_ip_protocol_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_protocol_cmd);
  install_element (VIEW_NODE, &show_outer_ip_protocol_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags2_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags2_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags2_tag_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags2_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags2_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags2_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags2_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags2_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_tag_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_distance2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_distance2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_tag_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_tag_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_distance_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_distance2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_distance2_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_tag_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_tag_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_tag_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_distance2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_tag_distance2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_tag_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_tag_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_tag_distance_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_tag_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_distance2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_tag_distance2_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_tag_distance2_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ip_route_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_tag_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_tag_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_nht_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_addr_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_longer_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_protocol_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_supernets_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_prefix_cmd);

  install_element (VIEW_NODE, &show_outer_ip_rpf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_rpf_addr_cmd);

  /* Commands for VRF */

  install_element (CONFIG_NODE, &outer_ip_mroute_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_mroute_dist_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_mroute_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_mroute_dist_vrf_cmd);

  install_element (CONFIG_NODE, &outer_ip_route_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags2_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags2_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_flags_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_distance_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ip_route_mask_flags_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_flags_distance2_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_distance_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ip_route_mask_flags_distance2_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ip_route_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_addr_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_longer_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_protocol_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_supernets_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_prefix_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ip_route_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_addr_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_prefix_longer_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_protocol_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_supernets_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_route_summary_prefix_vrf_all_cmd);

  install_element (VIEW_NODE, &show_outer_ip_rpf_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_rpf_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ip_rpf_addr_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ip_rpf_addr_vrf_all_cmd);

#if 0
  install_element (VIEW_NODE, &show_outer_ipv6_nht_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_pref_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_pref_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_pref_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_pref_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_pref_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_pref_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_pref_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_pref_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_pref_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_pref_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_pref_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_pref_tag_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_pref_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_pref_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_pref_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_pref_tag_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_pref_tag_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_pref_tag_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_tag_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_tag_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_prefix_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_protocol_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_addr_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_longer_cmd);

  install_element (VIEW_NODE, &show_outer_ipv6_mroute_cmd);

  /* Commands for VRF */

  install_element (CONFIG_NODE, &outer_ipv6_route_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_pref_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_flags_pref_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_pref_vrf_cmd);
  install_element (CONFIG_NODE, &outer_ipv6_route_ifname_flags_pref_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_pref_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_flags_pref_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_pref_vrf_cmd);
  install_element (CONFIG_NODE, &no_outer_ipv6_route_ifname_flags_pref_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ipv6_route_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_prefix_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_protocol_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_addr_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_vrf_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_longer_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ipv6_route_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_summary_prefix_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_protocol_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_addr_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_vrf_all_cmd);
  install_element (VIEW_NODE, &show_outer_ipv6_route_prefix_longer_vrf_all_cmd);

  install_element (VIEW_NODE, &show_outer_ipv6_mroute_vrf_cmd);

  install_element (VIEW_NODE, &show_outer_ipv6_mroute_vrf_all_cmd);
  install_element (ENABLE_NODE, &show_outer_ipv6_mroute_vrf_all_cmd);
#endif
}
